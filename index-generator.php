...
// Modify the strings to match your server setup:

if (strpos($_currentDir, 'www.google')) {
    $_documentRoot  = '/srv/html/www.google';
} elseif (strpos($_currentDir, 'www.amazon')) {
    $_documentRoot  = '/srv/html/www.amazon';
}
